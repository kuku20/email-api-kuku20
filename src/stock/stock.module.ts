...
@Module({
  imports:[JwtModule.register({}),TypeOrmModule.forFeature([DataHistory1d,DataHistory4h,DataHistory1h,DataHistory30m,DataHistory15m,DataHistory5m ,DataHistory1m])],
