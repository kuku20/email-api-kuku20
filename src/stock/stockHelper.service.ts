...
export class StockHelperService {
  ...
  FourHSList: string[] = ['C0B6QT628BE','C0B6ETS74UB','C0B6K76F79U','C0AV30D721L','C0B6P4EPGUR','C0B6QTBSCJ0','C0B6K7BB2BY','C0B6HTHQLJH','C0B7FJNF908'];
  DailyList: string[] = ['C0B5QLSF3FX','C0B5XL8DVB6','C0B6NB9HV6U','C0B02ENGMCH','C0B5QLEQZNH','C0B5MLVNYH1','C0B5QLGE6MB','C0B00B2N6NB','C0B0KECHWGL','C0B02EEHFQR'];
  ...
  IntradayList: string[] = ['SLACK_WEBHOOKS_US50','SLACK_WEBHOOKS_US200','SLACK_WEBHOOKS_US100','SLACK_WEBHOOKS_MACDCRAB']
