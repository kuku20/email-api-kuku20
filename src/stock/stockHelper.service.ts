...
export class StockHelperService {
  ...
  DailyList: string[] = ['C0B5QLSF3FX','C0B5XL8DVB6','C0B6NB9HV6U','C0B02ENGMCH','C0B5QLEQZNH','C0B5MLVNYH1','C0B5QLGE6MB','C0B00B2N6NB','C0B0KECHWGL','C0B02EEHFQR','C0B6PEXE4HZ','C0B6UVBFRRT'];
