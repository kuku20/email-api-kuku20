...
export class TasksUS_ALL_MK_MASS_MACD_OSC {
  ...
  async runOnly4hxx(stocklist) {
    ...
    const webhooks = ['C0B6K7BB2BY','C0B6K76F79U','C0B6QTBSCJ0','C0B6ETS74UB','C0B6P4EPGUR','C0B6QT628BE','C0AV30D721L','C0B6HTHQLJH','C0B7FJNF908','SLACK_WEBHOOKS_WATCHLIST','C0B6F49S3HT','C0B6C4Q6SHH','C0B6ME2MXGS']
